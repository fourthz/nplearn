...
alternative hypothesis is correct. Recall this question that we consider 
earlier.
...
rate of 70%, yet have the rate increase by 10 percentage points would seem 
...
We're still not there, but almost! We can actually all of the above on one 
line. Let's try 105.
